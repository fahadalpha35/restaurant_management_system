...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="{{ url('/') }}" class="brand-link reslogo" style="background: linear-gradient(90deg, rgba(48,55,107,1) 22%, rgba(20,175,11,1) 50%, rgba(48,55,107,1) 78%);border: 4px solid rgba(10, 116, 5, 0.68);">
