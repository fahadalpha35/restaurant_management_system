  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('/')}}" class="brand-link reslogo" style="background: radial-gradient(circle, rgba(245,250,255,1) 97%, rgba(63,94,251,1) 100%);border: 4px solid #007bff;">
      ...
      <!-- <center><img src="dist/img/orms.png" alt="AdminLTE Logo" class="elevation-1" style="width:220px;"></center> -->
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="dist/img/fahad.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Fahad Ahmed</a>
        </div>
      </div> -->
